...
void cc3_t3z_RHF_AAA() {
    ...
    int ab;
    double ***W1, ***W2;
    dpdbuf4<double>T2, E, F;
    dpdfile2<double>fIJ, fAB;
    dpdbuf4<double>ZIFLN, ZDFAN;
...
void cc3_t3z_RHF_AAB() {
    ...
    int ab;
    double ***W1, ***W2;
    dpdbuf4<double>T2AA, T2AB, T2BA, EAA, EAB, EBA, FAA, FAB, FBA;
    dpdfile2<double>fIJ, fAB, fij, fab;
    dpdbuf4<double>Dints, DAAints;
    dpdbuf4<double>ZIFLN, ZIfLn, ZDFAN, ZDfAn;
    int ji, kj;
    int Gbc, Gca, bc, ca;
