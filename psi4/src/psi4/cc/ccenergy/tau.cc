...
void CCEnergyWavefunction::tau_build() {
    ...
    dpdbuf4<double> tauIJAB, tauijab, tauIjAb, tauIjbA;
...
void CCEnergyWavefunction::tau_build_sp() {
    int i, j, a, b, I, J, A, B;
    int Isym, Jsym, Asym, Bsym;
    dpdbuf4<float> tauIjAb, tauIjbA;
    dpdbuf4<float> tIjAb;
    dpdfile2<float> tIA;
    ...
    if (params_.ref == 0) { /** RHF **/
        ...
        global_dpd_->buf4_copy_sp(&tIjAb, PSIF_CC_TAMPS, "tauIjAb_sp");
        ...
        /* This will generate the tauIjbA file from tauIjAb */
        global_dpd_->buf4_sort_sp(&tauIjAb, PSIF_CC_TAMPS, pqsr, 0, 5, "tauIjbA_sp");
