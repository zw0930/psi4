...
void CCEnergyWavefunction::init_amps() {
    ...
    if (params_.ref == 0) { /** RHF **/
        ...
        if (!params_.restart || !psio_tocscan(PSIF_CC_OEI, "tIA") || !psio_tocscan(PSIF_CC_OEI, "tia")) {
        ...
        if (!params_.restart || !psio_tocscan(PSIF_CC_TAMPS, "tIjAb") || !psio_tocscan(PSIF_CC_TAMPS, "tIJAB") ||
            !psio_tocscan(PSIF_CC_TAMPS, "tijab")) {
