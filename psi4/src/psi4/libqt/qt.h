...
// BLAS 1 Single routines
void C_SROT(size_t ntot, float* x, int incx, float* y, int incy, float costheta, float sintheta);
void C_SSWAP(size_t length, float* x, int incx, float* y, int inc_y);
...
double C_SNRM2(size_t n, float* X, int inc_x);
double C_SASUM(size_t n, float* X, int inc_x);
size_t C_IDAMAX(size_t n, float* X, int inc_x);
...
void C_SGEMV(char trans, int m, int n, float alpha, float* a, int lda, float* x, int incx, float beta,
                     float* y, int incy);
PSI_API
void C_SGER(int m, int n, float alpha, float* x, int incx, float* y, int incy, float* a, int lda);
