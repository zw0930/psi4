...
int DPD::buf4_init_sp(dpdbuf4<float> *Buf, int inputfile, int irrep, int pqnum, int rsnum, int file_pqnum, int file_rsnum,
...
int DPD::buf4_init_sp(dpdbuf4<float> *Buf, int inputfile, int irrep, string pq, string rs, string file_pq, string file_rs,
                   int anti, const char *label) {
    return buf4_init_sp(Buf, inputfile, irrep, pairnum(pq), pairnum(rs), pairnum(file_pq), pairnum(file_rs), anti, label);
}
...
int DPD::buf4_init_sp(dpdbuf4<float> *Buf, int inputfile, int irrep, string pq, string rs, int anti, const char *label) {
    return buf4_init_sp(Buf, inputfile, irrep, pairnum(pq), pairnum(rs), pairnum(pq), pairnum(rs), anti, label);
}
