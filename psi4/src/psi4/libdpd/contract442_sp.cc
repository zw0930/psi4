 ...
 */
int DPD::contract442_sp(dpdbuf4<float> *X, dpdbuf4<float> *Y, dpdfile2<float> *Z, int target_X, int target_Y, float alpha, float beta) {
    int h, hxbuf, hybuf, nirreps, Gtar, GX, GY, GZ, Hx, Hy, Hz, hlinks;
    int rking = 0;
    dpdtrans4<float> Xt, Yt;
    float ***Xmat, ***Ymat, ***Zmat;
    ...
    print_mat(Ymat[Hy], numlinks[Hx], Z->params->coltot[Hz^GZ], outfile);
        ...
        */
                ...
                newmm_rking_sp(Xmat[Hx], Xtrans, Ymat[Hy], Ytrans, Z->matrix[Hz], Z->params->rowtot[Hz], numlinks[Hx],
