...
*/
int DPD::buf4_axpbycz_sp(dpdbuf4<float> *FileA, dpdbuf4<float> *FileB, dpdbuf4<float> *FileC, float a, float b, float c) {
    buf4_scm_sp(FileC, c);

    buf4_axpy_sp(FileB, FileC, b);

    buf4_axpy_sp(FileA, FileC, a);
    return 0;
}
}  // namespace psi
