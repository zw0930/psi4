...
int DPD::contract422_sp(dpdbuf4<float> *X, dpdfile2<float> *Y, dpdfile2<float> *Z, int trans_Y, int trans_Z, float alpha, float beta) {
    ...
    file2_mat_rd_sp(Y);
    file2_mat_init_sp(Z);
    if (std::fabs(beta) > 0.0) file2_mat_rd_sp(Z);
