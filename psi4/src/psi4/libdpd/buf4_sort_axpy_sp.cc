            ...
            if (incore) {
                ...
                for (Gpq = 0; Gpq < nirreps; Gpq++) {
                    ...
                    for (n = 0; n < (rows_left ? nbuckets - 1 : nbuckets); n++) {
                        ...
                        buf4_mat_irrep_rd_block_sp(&OutBuf, Gpq, row_start, rows_per_bucket);
                        buf4_mat_irrep_rd_block_sp(InBuf, Gpq, row_start, rows_per_bucket);
                        ...
                        buf4_mat_irrep_wrt_block_sp(&OutBuf, Gpq, row_start, rows_per_bucket);
                    }
                    if (rows_left) {
                        row_start = n * rows_per_bucket;
                        buf4_mat_irrep_rd_block_sp(&OutBuf, Gpq, row_start, rows_left);
                        buf4_mat_irrep_rd_block_sp(InBuf, Gpq, row_start, rows_left);
                        ...
                        buf4_mat_irrep_wrt_block_sp(&OutBuf, Gpq, row_start, rows_left);
                    }
            ...
            if (incore) {
                ...
                for (Gpq = 0; Gpq < nirreps; Gpq++) {
                    ...
                    for (n = 0; n < (out_rows_left ? out_nbuckets - 1 : out_nbuckets); n++) {
                        ...
                        buf4_mat_irrep_rd_block_sp(&OutBuf, Gpq, out_row_start, out_rows_per_bucket);
                    ...
                    if (out_rows_left) {
                        out_row_start = n * out_rows_per_bucket;
                        buf4_mat_irrep_rd_block_sp(&OutBuf, Gpq, out_row_start, out_rows_left);
            ...
            if (incore) {
                ...
                for (Gpq = 0; Gpq < nirreps; Gpq++) {
                    ...
                    for (n = 0; n < (out_rows_left ? out_nbuckets - 1 : out_nbuckets); n++) {
                        ...
                        for (m = 0; m < (in_rows_left ? in_nbuckets - 1 : in_nbuckets); m++) {
                            in_row_start = m * in_rows_per_bucket;
                            buf4_mat_irrep_rd_block_sp(InBuf, Grs, in_row_start, in_rows_per_bucket);
                        ...
                        if (in_rows_left) {
                            in_row_start = m * in_rows_per_bucket;
                            buf4_mat_irrep_rd_block_sp(InBuf, Grs, in_row_start, in_rows_left);
