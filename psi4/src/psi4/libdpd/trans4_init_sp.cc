...
int DPD::trans4_init_sp(dpdtrans4<float> *Trans, dpdbuf4<float> *Buf) {
    int nirreps;
    ...
    Trans->matrix = (float ***)malloc(nirreps * sizeof(float **));
    ...
    Trans->shift.matrix = (float ****)malloc(nirreps * sizeof(float ***));
