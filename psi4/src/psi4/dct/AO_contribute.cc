...
void DCTSolver::AO_contribute(dpdbuf4<double> *tau1_AO, dpdbuf4<double> *tau2_AO, int p, int q, int r, int s, double value,
                               dpdfile2<double> *s1, dpdfile2<double> *s1b, dpdfile2<double> *s2) {
